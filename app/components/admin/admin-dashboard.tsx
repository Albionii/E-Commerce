...
// Import the ContactManagement component at the top
  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        ...
        console.log("Basic stats fetched:", { productsData, usersData, ordersData })
        ...
        try {
          ...
          // Don't fail the whole dashboard for revenue stats
        }
